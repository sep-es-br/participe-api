...
public interface CommentRepository extends Neo4jRepository<Comment, Long> {
    ...
    List<Comment> findByIdPersonAndIdPlanItemAndIdConferenceAndIdLocality(@Param("idPerson") Long idPerson,
            @Param("idPlanItem") Long idPlanItem, @Param("idConference") Long idConference,
            @Param("idLocality") Long idLocality);

    @Query(value = "MATCH (comment:Comment)-[:ABOUT]->(conference:Conference), "
    ...
    Page<Comment> findAllCommentsByConference(@Param("idConference") Long idConference, @Param("status") String status,
            @Param("text") String text, @Param("localityIds") Long[] localityIds,
            @Param("planItemIds") Long[] planItemIds, @Param("pageable") Pageable pageable);
    ...
    ModerationResultDto findModerationResultById(@Param("idComment") Long idComment,
